...
namespace SimAI.Core.Tokenization.Steps {
    public class ConvertNumericTextStep : IsTokenizationStep {

        private static readonly Dictionary<string, long> _table =
            new() {{"zero",0},{"one",1},{"two",2},{"three",3},{"four",4},
